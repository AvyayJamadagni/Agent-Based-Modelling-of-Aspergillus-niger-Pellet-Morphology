...
# ---- Hypha growth ----
MU_MAX = 19.77            # maximum tip growth rate (µm/hr)
DEPLETION_RADIUS = 20.0  # radius (µm) around a tip used for sensing & depletion
HYPHA_RADIUS_UM = 1.4   # physical radius of the hypha cylinder (µm)

# ---- Apical branching ----
PSI_BRANCH = 0.88             # branch when  ψ · μ_{t-1} ≥ μ_t  (drop-in-rate threshold)
