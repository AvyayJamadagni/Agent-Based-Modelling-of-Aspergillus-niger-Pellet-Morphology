...
# ---- Hypha growth ----
MU_MAX = 2.93            # maximum tip growth rate (µm/hr)
...
DIFFUSION_STRENGTH = 0.05       # α for the fastest species (must be ≤ 1/6 for stability in 3D)
DIFFUSION_SUBSTEPS = 30         # number of explicit-Euler sub-iterations per simulation step
