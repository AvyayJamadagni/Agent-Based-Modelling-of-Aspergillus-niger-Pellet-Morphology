...
# ---- Hypha growth ----
MU_MAX = 19.51            # maximum tip growth rate (µm/hr)
...
PHI_N = 0.9875                      # local N ≥ PHI_N · [N]_init required for a lateral branch
PHI_P = 0.9875                      # local P ≥ PHI_P · [P]_init required for a lateral branch
